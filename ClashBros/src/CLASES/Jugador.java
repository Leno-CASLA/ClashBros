...
public class Jugador {
    ...
    public void update(ArrayList<Enemigo> enemigos,
        ...
        for (BloqueNormal b : bloquesNormales) b.handleCollision(this);
                ...
                if (velY < 0) {
                    ...
                    if (!b.isHit()) {
                        ...
                        switch (b.getContenido()) {
                            case MONEDA: callbacks.addMoneda(new Moneda(b.getX(), b.getY() - 32)); break;
                            case HONGO: callbacks.addHongo(new Hongo(b.getX(), b.getY() - 32)); break;
                        }
                    }
                } else if (y + height > b.getY() && y < b.getY() + b.getHeight()) {
                    x -= velX;
                }
                playerBounds = getBounds();
            }
    ...
    public void revertToNormal() { poweredUp = false; width = normalWidth; height = normalHeight; }
